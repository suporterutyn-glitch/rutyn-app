-- fase2 del professor, sin los bloques de exercises/foods.
-- Esas dos tablas fueron redefinidas despues por 20260921120000_final_foods_exercises_migration
-- (owner_id/name_pt -> trainer_id/name), asi que recrearlas o indexarlas por owner_id falla.
